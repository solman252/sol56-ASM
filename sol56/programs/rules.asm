...
#ruledef {
    ; ---- Special Instructions ---- {
        ...
        ; -- NOP -- {
            ...
            nop {r1: reg} => 0x00 @ 0x01 @ r1`4 @ 0x0 @ 0x0000 @ 0x0000
        ...
        ; -- INTD -- {
            ...
            intd {r1: reg}, {r2: reg} => 0x01 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            intd {r1: reg}, {v2: u8} =>  0x01 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x00 @ v2`8
            intd {v1: u16}, {r2: reg} => 0x01 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
        ...
        ; -- INTR -- {
            ...
            intr reg, {r: reg} => 0x20 @ 0x01 @ r`4 @ 0x0 @ 0x0000 @ 0x0000
        ...
        ; -- INT {
            ...
            int {r1: reg} => 0x03 @ 0x00 @ r1`4 @ 0x0 @ 0x0000      @ 0x000
        ...
        ; -- HLT -- {
            ...
            hlt {r1: reg} => 0x04 @ 0x01 @ r1`4 @ 0x0 @ 0x0000      @ 0x0000
            hlt {v1: u8} =>  0x04 @ 0x02 @ 0x0  @ 0x0 @ 0x00 @ v1`8 @ 0x0000
        ; }

        ; -- TIME -- {
            ; Store an aspect of the time (see time_modes) into a register.
            time {m: time_modes}, {r1: reg} => 0x05 @ 0x0 @ m`4 @ r1`4 @ 0x0 @ 0x0000 @ 0x0000
        ;}
    ...
    ; ---- ALU Operations ---- {
        ...
        ; -- FLAG -- {
            ...
            flag {f: flag}, {v: u1} => 0x06 @ f`4 @ 0b000 @ v`1 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000
        ...
        ; -- ADD -- {
            ...
            add {r1: reg}, {r2: reg} => 0x07 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            add {r1: reg}, {v2: i16} => 0x07 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            add {v1: i16}, {r2: reg} => 0x07 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            add {v1: i16}, {v2: i16} => 0x07 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16

            ; Same as add, but with carry in.
            addc {r1: reg}, {r2: reg} => 0x07 @ 0x10 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            addc {r1: reg}, {v2: i16} => 0x07 @ 0x11 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            addc {v1: i16}, {r2: reg} => 0x07 @ 0x12 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            addc {v1: i16}, {v2: i16} => 0x07 @ 0x13 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- SUB -- {
            ; Subtract one value from another and store the result in the RES register.
            sub {r1: reg}, {r2: reg} => 0x08 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            sub {r1: reg}, {v2: i16} => 0x08 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            sub {v1: i16}, {r2: reg} => 0x08 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            sub {v1: i16}, {v2: i16} => 0x08 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- MOD -- {
            ; Modulo one value by another and store the result in the RES register.
            mod {r1: reg}, {r2: reg} => 0x09 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            mod {r1: reg}, {v2: i16} => 0x09 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            mod {v1: i16}, {r2: reg} => 0x09 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            mod {v1: i16}, {v2: i16} => 0x09 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- AND -- {
            ; Perform a bitwise and between 2 values and store the result in the RES register.
            and {r1: reg}, {r2: reg} => 0x0A @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            and {r1: reg}, {v2: i16} => 0x0A @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            and {v1: i16}, {r2: reg} => 0x0A @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            and {v1: i16}, {v2: i16} => 0x0A @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- OR -- {
            ; Perform a bitwise or between 2 values and store the result in the RES register.
            or {r1: reg}, {r2: reg} => 0x0B @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            or {r1: reg}, {v2: i16} => 0x0B @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            or {v1: i16}, {r2: reg} => 0x0B @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            or {v1: i16}, {v2: i16} => 0x0B @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }
        
        ; -- XOR -- {
            ; Perform a bitwise xor between 2 values and store the result in the RES register.
            xor {r1: reg}, {r2: reg} => 0x0C @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            xor {r1: reg}, {v2: i16} => 0x0C @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            xor {v1: i16}, {r2: reg} => 0x0C @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            xor {v1: i16}, {v2: i16} => 0x0C @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- XNOR -- {
            ; Perform a bitwise xnor between 2 values and store the result in the RES register.
            xnor {r1: reg}, {r2: reg} => 0x0D @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            xnor {r1: reg}, {v2: i16} => 0x0D @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            xnor {v1: i16}, {r2: reg} => 0x0D @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            xnor {v1: i16}, {v2: i16} => 0x0D @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
        ; }

        ; -- BSL -- {
            ; Bit-shift a value by another value to the left and store the result in the RES register.
            bsl {r1: reg}, {r2: reg} => 0x0E @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            bsl {r1: reg}, {v2: u16} => 0x0E @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            bsl {v1: i16}, {r2: reg} => 0x0E @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            bsl {v1: i16}, {v2: u16} => 0x0E @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
            bsl {r1: reg} => asm { bsl {r1}, 1 }
        ; }

        ; -- BSR -- {
            ; Bit-shift a value by another value to the right and store the result in the RES register.
            bsr {r1: reg}, {r2: reg} => 0x0F @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            bsr {r1: reg}, {v2: u16} => 0x0F @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            bsr {v1: i16}, {r2: reg} => 0x0F @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            bsr {v1: i16}, {v2: u16} => 0x0F @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
            bsr {r1: reg} => asm { bsr {r1}, 1 }
        ; }

        ; -- BRL -- {
            ; Bit-rotate a value by another value to the left and store the result in the RES register.
            brl {r1: reg}, {r2: reg} => 0x10 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            brl {r1: reg}, {v2: u16} => 0x10 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            brl {v1: i16}, {r2: reg} => 0x10 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            brl {v1: i16}, {v2: u16} => 0x10 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
            brl {r1: reg} => asm { brl {r1}, 1 }
        ; }

        ; -- BRR -- {
            ; Bit-rotate a value by another value to the right and store the result in the RES register.
            brr {r1: reg}, {r2: reg} => 0x11 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            brr {r1: reg}, {v2: u16} => 0x11 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            brr {v1: i16}, {r2: reg} => 0x11 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            brr {v1: i16}, {v2: u16} => 0x11 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
    ...
    ; ---- Register / Memory Management ---- {
        ...
        ; -- MOV -- {
            ...
            mov {r1: reg}, {r2: reg} => 0x12 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            mov {r1: reg}, {v1: i16} => 0x12 @ 0x01 @ r1`4 @ 0x0  @ v1`16  @ 0x0000
            mov {r1: reg}, {f: flag} => 0x12 @ 0x02 @ r1`4 @ f`4  @ 0x0000 @ 0x0000

            ; Copy the right value into all registers.
            mov all, {r2: reg} => 0x12 @ 0x10 @ 0x0 @ r2`4 @ 0x0000 @ 0x0000
            mov all, {v1: i16} => 0x12 @ 0x11 @ 0x0 @ 0x0  @ v1`16  @ 0x0000
            mov all, {f: flag} => 0x12 @ 0x12 @ 0x0 @ f`4  @ 0x0000 @ 0x0000
        ; }

        ; -- LDR -- {
            ; Copy the value in RAM at the right address into the left register.
            ldr {r1: reg}, [{r2: reg}] => 0x13 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            ldr {r1: reg}, [{v1: u16}] => 0x13 @ 0x01 @ r1`4 @ 0x0  @ v1`16  @ 0x0000

            ; Copy the value in RAM at the right address into all registers.
            ldr all, {r2: reg} => 0x13 @ 0x00 @ 0x0  @ r2`4 @ 0x0000 @ 0x0000
            ldr all, {v1: i16} => 0x13 @ 0x01 @ 0x0  @ 0x0  @ v1`16  @ 0x0000

            ; - Macros - {
                mov {r1: reg}, [{r2: reg}] => asm { ldr {r1}, [{r2}] }
                mov {r1: reg}, [{v1: u16}] => asm { ldr {r1}, [{v1}] }
            ; }
        ...
        ; -- STR -- {
            ...
            str {r1: reg}, [{r2: reg}] => 0x14 @ 0x00 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            str {r1: reg}, [{v2: u16}] => 0x14 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
            str {v1: i16}, [{r2: reg}] => 0x14 @ 0x02 @ 0x0  @ r2`4 @ v1`16  @ 0x0000
            str {v1: i16}, [{v2: u16}] => 0x14 @ 0x03 @ 0x0  @ 0x0  @ v1`16  @ v2`16
            str {f: flag}, [{r2: reg}] => 0x14 @ 0x10 @ r1`4 @ r2`4 @ 0x0000 @ 0x0000
            str {f: flag}, [{v2: u16}] => 0x14 @ 0x11 @ r1`4 @ 0x0  @ 0x0000 @ v2`16
    ...
    ; ---- Jump Instructions ---- {
        ...
        ; -- JMP -- {
            ...
            jmp {r1: reg} => 0x15 @ 0x00 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
            jmp {v1: u16} => 0x15 @ 0x01 @ 0x0  @ 0x0  @ v1`16  @ 0x0000
        ; }
        ...
        ; -- JEQ -- {
            ...
            jeq {r1: reg}, {r2: reg}, {v1: u16} => 0x18 @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jeq, but compare one register's value to 0.
            jeqz {r1: reg}, {v1: u16}           => 0x18 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }

        ; -- JNE -- {
            ; Conditionally jump to an address if the value in one register is not equal to another.
            jne {r1: reg}, {r2: reg}, {v1: u16} => 0x19 @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jne, but compare one register's value to 0.
            jnez {r1: reg}, {v1: u16}           => 0x19 @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }

        ; -- JLT -- {
            ; Conditionally jump to an address if the value in one register is less than another.
            jlt {r1: reg}, {r2: reg}, {v1: u16} => 0x1A @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jlt, but compare one register's value to 0.
            jltz {r1: reg}, {v1: u16}           => 0x1A @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }

        ; -- JGT -- {
            ; Conditionally jump to an address if the value in one register is greater than another.
            jgt {r1: reg}, {r2: reg}, {v1: u16} => 0x1B @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jgt, but compare one register's value to 0.
            jgtz {r1: reg}, {v1: u16}           => 0x1B @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }

        ; -- JLE -- {
            ; Conditionally jump to an address if the value in one register is less than or equal to another.
            jle {r1: reg}, {r2: reg}, {v1: u16} => 0x1C @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jle, but compare one register's value to 0.
            jlez {r1: reg}, {v1: u16}           => 0x1C @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }

        ; -- JGE -- {
            ; Conditionally jump to an address if the value in one register is greater than or equal to another.
            jge {r1: reg}, {r2: reg}, {v1: u16} => 0x1D @ 0x00 @ r1`4 @ r2`4 @ v1`16  @ 0x0000

            ; Same as jge, but compare one register's value to 0.
            jgez {r1: reg}, {v1: u16}           => 0x1D @ 0x01 @ r1`4 @ 0x0  @ 0x0000 @ 0x0000
        ; }
    ; }
    ...
    ; ---- Power Instructions ---- {
        ...
        ; -- PWD -- {
            ...
            pwd => 0x1E @ 0x00 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000
        ; }

    ; }

    ; ---- Video Instructions ---- {
        vid mode, rgb => 0x1F @ 0x00 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000
        vid mode, vga => 0x1F @ 0x01 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000

        vid flush => 0x20 @ 0x00 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000

        vid clear => 0x21 @ 0x00 @ 0x0 @ 0x0 @ 0x0000 @ 0x0000

        vid set, {r1: reg}, {r2: reg}, {c1: reg}, {c2: reg}, {c3: reg} => 0x22 @ 0x00 @ r1`4 @ r2`4@ c1`4 @ c2`4 @ c3`4 @ 0x0 @ 0x0000
        vid set, {r1: reg}, {r2: reg}, {c: u24} => 0x22 @ 0x01 @ r1`4 @ r2`4@ c`24 @ 0x00
    ; }
